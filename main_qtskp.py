...
# specific for the quadratic two-stage stochastic knapsack problem with setup
# load environment:
from environment import qtskp_Env as Env 
...
for N in [10] : # number of second stage variables (n_y)
    for l in [10, 15, 20] :
        ...
        for K in [2, 3, 4, 5]:
            ...
            pp = pf_qtskp.qtskp_Inst(tmax = tmax)
