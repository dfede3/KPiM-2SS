...
# specific for the quadratic two-stage stochastic capacitated facility location problem
# load environment:
from environment import qcfl_Env as Env
# load problem-specific functions:
import pf_qcfl

# list of solvers we test:
solvers = ['complete_enum','PiM']
...
print('Tests for qcfl:')

for N in [10] : # number of first stage variables (n_y)
    for l in [10, 15, 20] :
        ...
        for K in [2,3,4,5]:
            ...
            pp = pf_qcfl.qcfl_Inst(tmax = tmax)
